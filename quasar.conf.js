    ...
    build: {
      ...
      env: {
        ...
        VUE_FHIR_REDIRECT_URL: ctx.dev
          ...
          : 'https://i4mi.github.io/midata-quasar-starter-app/#/search', // enter here production url for midata redirect, this url also has to be declared in the Midata app declaration
      },
