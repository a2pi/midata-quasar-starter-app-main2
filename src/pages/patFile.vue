<template>
  <q-page padding>
    ...
    <table border="0">
        ...
        <tr>
            <td>
                PLZ <input type="text" placeholder="plz">
            </td>
            <td>
                Ort <input type="text" placeholder="ort">
            </td>
        </tr>
        <tr>
            <td colspan="2">
                Telefon <input type="tel" placeholder="Telefonnummer">
            </td>
        </tr>
        <tr>
            <td colspan="2">
                E-mail <input type="email" placeholder="Nachname">
            </td>
        </tr>
        <tr>
            <td colspan="2">
