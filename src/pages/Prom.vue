...
export default {
  ...
  methods: {
    async setQuestionaire() {
      ...
      await saveToMidata(encounterFHIRID, questionnaireResponse);
    },
    ...
    async getActiveEpisodeOfCare() {
      ...
      const episodeOfCare = activeEOC ? activeEOC : this.$midata.getNewEpisodeOfCare();
  ...
  <q-page padding>
    <table>
      ...
      <tr>
        ...
        <td class='col_form'><q-radio v-model='answer1' val='5' size='80px' /><br />5</td>
        <td class='col_form'><q-radio v-model='answer1' val='4' size='80px' /><br />4</td>
        <td class='col_form'><q-radio v-model='answer1' val='3' size='80px' /><br />3</td>
        <td class='col_form'><q-radio v-model='answer1' val='2' size='80px' /><br />2</td>
        <td class='col_form'><q-radio v-model='answer1' val='1' size='80px' /><br />1</td>
      </tr>
      <tr>
        <td colspan='6' class='separators'></td>
      </tr>
      <tr>
        <td class='answer'>Wie würden Sie Ihre Lebensqualität insgesamt beschreiben?</td>
        <td class='col_form'><q-radio v-model='answer2' val='5' size='80px' /><br />5</td>
        <td class='col_form'><q-radio v-model='answer2' val='4' size='80px' /><br />4</td>
        <td class='col_form'><q-radio v-model='answer2' val='3' size='80px' /><br />3</td>
        <td class='col_form'><q-radio v-model='answer2' val='2' size='80px' /><br />2</td>
        <td class='col_form'><q-radio v-model='answer2' val='1' size='80px' /><br />1</td>
      </tr>
      <tr>
        <td colspan='6' class='separators'></td>
      </tr>
      <tr>
        <td class='answer'>
          Wie würden Sie Ihren körperlichen Gesundheitszustand insgesamt beschreiben?
        </td>
        <td class='col_form'><q-radio v-model='answer3' val='5' size='80px' /><br />5</td>
        <td class='col_form'><q-radio v-model='answer3' val='4' size='80px' /><br />4</td>
        <td class='col_form'><q-radio v-model='answer3' val='3' size='80px' /><br />3</td>
        <td class='col_form'><q-radio v-model='answer3' val='2' size='80px' /><br />2</td>
        <td class='col_form'><q-radio v-model='answer3' val='1' size='80px' /><br />1</td>
      </tr>
      <tr>
        <td colspan='6' class='separators'></td>
      </tr>
      <tr>
        <td class='answer'>
          Wie würden Sie Ihre psychische Verfassung insgesamt beschreiben? Dazu zählen
          Ihre Stimmung und Ihre Fähigkeit, klar zu denken.
        </td>
        <td class='col_form'><q-radio v-model='answer4' val='5' size='80px' /><br />5</td>
        <td class='col_form'><q-radio v-model='answer4' val='4' size='80px' /><br />4</td>
        <td class='col_form'><q-radio v-model='answer4' val='3' size='80px' /><br />3</td>
        <td class='col_form'><q-radio v-model='answer4' val='2' size='80px' /><br />2</td>
        <td class='col_form'><q-radio v-model='answer4' val='1' size='80px' /><br />1</td>
      </tr>
      <tr>
        <td colspan='6' class='separators'></td>
      </tr>
      <tr>
        <td class='question'>
          Wie zufrieden sind Sie insgesamt mit Ihren Aktivitäten mit anderen Menschen und
          mit Ihren Beziehungen zu anderen?
        </td>
        <td class='col_form'><q-radio v-model='answer5' val='5' size='80px' /><br />5</td>
        <td class='col_form'><q-radio v-model='answer5' val='4' size='80px' /><br />4</td>
        <td class='col_form'><q-radio v-model='answer5' val='3' size='80px' /><br />3</td>
        <td class='col_form'><q-radio v-model='answer5' val='2' size='80px' /><br />2</td>
        <td class='col_form'><q-radio v-model='answer5' val='1' size='80px' /><br />1</td>
      </tr>
      <tr>
        <td colspan='6' class='separators'></td>
      </tr>
      <tr>
        <td class='question'>
          Wie gut sind Sie insgesamt in der Lage, Aktivitäten mit anderen Menschen
          nachzugehen und Ihre Rollen im Alltag und in der Gemeinschaft auszufüllen? (Dazu
          zählen Aktivitäten zu Hause, am Arbeitsplatz, in Ihrem Umfeld sowie Ihre
          Aufgaben als Elternteil, Sohn, Tochter, Lebenspartner/-in, im Berufsleben, in
          Ihrem Freundeskreis usw.) .........
        </td>
        <td class='col_form'><q-radio v-model='answer6' val='5' size='80px' /><br />5</td>
        <td class='col_form'><q-radio v-model='answer6' val='4' size='80px' /><br />4</td>
        <td class='col_form'><q-radio v-model='answer6' val='3' size='80px' /><br />3</td>
        <td class='col_form'><q-radio v-model='answer6' val='2' size='80px' /><br />2</td>
        <td class='col_form'><q-radio v-model='answer6' val='1' size='80px' /><br />1</td>
      </tr>
      <tr>
        <td colspan='6' class='separators'></td>
      </tr>
      ...
      <tr>
        <td class='question'>
          Inwieweit sind Sie in der Lage, alltägliche körperliche Aktivitäten auszuführen,
          z. B. Gehen, Treppensteigen, Einkäufe tragen oder Stühle verschieben?
        </td>
        <td class='col_form'><q-radio v-model='answer7' val='5' size='80px' /><br />5</td>
        <td class='col_form'><q-radio v-model='answer7' val='4' size='80px' /><br />4</td>
        <td class='col_form'><q-radio v-model='answer7' val='3' size='80px' /><br />3</td>
        <td class='col_form'><q-radio v-model='answer7' val='2' size='80px' /><br />2</td>
        <td class='col_form'><q-radio v-model='answer7' val='1' size='80px' /><br />1</td>
      </tr>
      <tr>
        <td style='background-color: rgb(255, 255, 255)'>
      ...
      <tr>
        ...
        <td class='col_form'><q-radio v-model='answer8' val='5' size='80px' /><br />5</td>
        <td class='col_form'><q-radio v-model='answer8' val='4' size='80px' /><br />4</td>
        <td class='col_form'><q-radio v-model='answer8' val='3' size='80px' /><br />3</td>
        <td class='col_form'><q-radio v-model='answer8' val='2' size='80px' /><br />2</td>
        <td class='col_form'><q-radio v-model='answer8' val='1' size='80px' /><br />1</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class='question'>Wie ausgeprägt war Ihre Müdigkeit im Allgemeinen?</td>
        <td class='col_form'><q-radio v-model='answer9' val='5' size='80px' /><br />5</td>
        <td class='col_form'><q-radio v-model='answer9' val='4' size='80px' /><br />4</td>
        <td class='col_form'><q-radio v-model='answer9' val='3' size='80px' /><br />3</td>
        <td class='col_form'><q-radio v-model='answer9' val='2' size='80px' /><br />2</td>
        <td class='col_form'><q-radio v-model='answer9' val='1' size='80px' /><br />1</td>
      </tr>
      <tr>
        <td colspan='6' class='separators'></td>
      </tr>
    ...
    <table width='100%'>
      <tr>
        ...
        <td rowspan='2' class='col_form'>
          <q-radio v-model='answer10' val='0' size='80px' /><br />0 <br /><strong
            >Keine Schmerzen</strong
          >
        </td>
        <td class='col_form'>
        ...
        <td class='col_form'>
          <q-radio v-model='answer10' val='10' size='80px' /><br />10 <br /><strong
            >Schlimmste vorstellbare Schmerzen</strong
          >
        </td>
      </tr>
    </table>
